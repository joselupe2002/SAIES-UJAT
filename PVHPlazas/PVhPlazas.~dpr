...
begin
 ...
 BQuery.Sql.Add ('Delete From PhPlazas Where PLAZ_PLAZA= '+
  xmodulo.Query1.FieldByName('VPLA_PLAZA').AsString );
 try
  BQuery.ExecSql ;
...
begin
 ...
 case xmodulo.modo of
  ...
  4 : if Application.MessageBox('Borrar Plaza HAS','Confirmar',
