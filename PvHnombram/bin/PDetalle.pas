...
begin
 if GQBE.Visible then Acepta_QBE                    // Acepta QBE        DEL F8
 ...
 try
  ...
  then close
   ...
   begin
    ...
    //desactivar para evitar recaptura 06/julio/01
...
begin
 ...
 QVal.Open ;
 ///AQUI CONCATENA LA L A LA CAJA DE TEXTO
