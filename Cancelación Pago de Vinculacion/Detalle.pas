...
begin
  inherited;
  tppagos:='PiPAGOS'; TPDPAGOS:='PiDPAGOS';
...
begin
  ...
  IF FPAGO.ItemIndex>=0 THEN
     begin
        q.close;
        q.SQL.text:='CALL CANCELAPAGODINV('+#39+PAGO.TEXT+#39+','+inttostr(fpago.itemindex)+
...
if Application.MessageBox('Seguro que desea Cancelar el Pago','Confirmar',
         ...
         begin
             ...
             q.Close;
             q.sql.text:='INSERT INTO PICANCELPAGO '+
             ...
             Q.close;
             q.sql.text:='UPDATE PICANCPAGO SET '+
