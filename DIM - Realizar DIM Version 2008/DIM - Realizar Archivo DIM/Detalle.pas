...
begin
  ...
  cont:=1;
  q.close;
  q.SQL.text:='SELECT * FROM PDIMFINAL_2012 where ENVIAR='+#39+'S'+#39+' ORDER BY EMPL';
  Q.open;
                ...
                IF Q.fieldbyname('MOVIMIENTO').asstring='HAS' THEN
                 ...
                 IF Q.fieldbyname('MOVIMIENTO').asstring<>'HAS' THEN
                    begin
                       ...
                       '|'+                     //120.  Suma de las cantidades credito al salario
                       '|'+                     //121.  Credito al salario entregado en efectivo
                       Q.fieldbyname('PREV_SOLICIA_E').asstring+'|'+                     //122.  Monto previsión social
                       Q.fieldbyname('PREV_SOLICIA_E').asstring+'|'+                     //123.  Monto previsión social  exento
