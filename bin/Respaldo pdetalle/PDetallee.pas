...
type
  TPFDetalle = class(TForm)
    ...
    procedure QValUpdateRecord(DataSet: TDataSet; UpdateKind: TUpdateKind; var UpdateAction: TUpdateAction);
    ...
    procedure ValCam(Sender : TField) ; virtual ;                 // Para Letreros
  private
...
begin
 ...
 //showmessage('antes del update2 en grabaupdate');
 //QUpdate2.ExecSQL;
 end ;
...
// Grabamos en la Base de Datos
 ...
 try
 // Forma := TFdetalle.Create(Application);
