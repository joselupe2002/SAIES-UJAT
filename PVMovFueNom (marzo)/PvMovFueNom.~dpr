...
begin
  ...
  S.close;
  s.sql.text:='SELECT BECA_NIVEL FROM PBECAEMPL S WHERE S.BECA_EMPL='+#39+q.fieldbyname('VMOV_PERS').asstring+#39;
  S.open;
...
exports Detalle, Autorizar,Contab, devengar, impRep, impRec, impRepDet, verOrden ;
begin
//
end.
