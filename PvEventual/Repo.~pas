...
QTEMP.CLOSE;
QTEMP.Params.ParamValues['EVENTUAL'] := clipboard.AsText ;
QTEMP.OPEN;

QDIRIGIDO.CLOSE;
QDIRIGIDO.Params.ParamValues['EVENTUAL'] := clipboard.AsText ;
QDIRIGIDO.OPEN;
...
QcopiaD.CLOSE;
QcopiaD.Params.ParamValues['EVENTUAL'] := clipboard.AsText ;
QcopiaD.OPEN;

QcopiaT.CLOSE;
QcopiaT.Params.ParamValues['EVENTUAL'] := clipboard.AsText ;
QcopiaT.OPEN;
