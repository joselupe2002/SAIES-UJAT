...
type
  TFRepo = class(TPFRepo)
    ...
    QPstoDetSINDICATO3: TStringField;
    ...
    QRDBText6: TQRDBText;
    QRDBText9: TQRDBText;
    QPstoUrATPLAZA: TStringField;
    QPstoUrASUELDO: TFloatField;
...
QTEMP.CLOSE;
QTEMP.Params.ParamValues['Empl'] := clipboard.AsText ;
QTEMP.OPEN;
...
Qescolaridad.OPEN;
  ...
  QFoto.ParamByName('Persona').AsString := clipboard.AsText ;
  QFoto.Close ;
  QFoto.Open ;
