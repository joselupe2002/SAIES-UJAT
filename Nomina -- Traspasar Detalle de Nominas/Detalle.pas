...
begin
  ...
  Q.execsql;
  Showmessage('Se han copiado los detalles de nomina a tabla de contabilización');

  QpERDED.close;
  QpERDED.sql.text:='select DECODE(T.CONT_TIPO,'+#39+'P'+#39+','+#39+'PERCEPCIÓN'+#39+','+#39+'DEDUCCIÓN'+#39+') '+
...
begin
  ...
  if nomina.text<>'' then
    ...
    Showmessage('Elija una nómina correcta');
...
begin
  inherited;
if nomina.Text<>'' then
   ImprimeRepEmpl('CONTOPNOM.RTF','RELACIÓN DE ÓRDENES DE PAGO DE LOS ACADÉMICOS QUE COBRAN POR CHEQUE')
else
   Showmessage('Seleccione una nómina en la pestaña número 1');
end;
...
begin
  inherited;
  if nomina.Text<>'' then
     ImprimeRepDJ('CONTOPNOMDJ.RTF','RELACIÓN DE LAS ÓRDENES DE PAGO DE LOS DESCUENTOS JUDICIALES QUE SE LES EMITE CHEQUE')
else
   Showmessage('Seleccione una nómina en la pestaña número 1');
...
begin
  inherited;
  if nomina.Text<>'' then
     ImprimeRepPFiltro('P1225','CONTOPNOMP.RTF','RELACIÓN DE LAS ÓRDENES DE PAGO INFONAVIT',datetostr(ini.date),datetostr(ter.date))
  else
     Showmessage('Seleccione una nómina en la pestaña número 1');
...
begin
  inherited;
  if nomina.Text<>'' then
     ImprimeRepPFiltro('P8947','CONTOPNOMP.RTF','RELACIÓN DE LAS ÓRDENES DE PAGO IMSS',datetostr(ini.date),datetostr(ter.date))
  else
     Showmessage('Seleccione una nómina en la pestaña número 1');
