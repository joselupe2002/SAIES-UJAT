...
begin
 ...
 BQuery.Sql.Add ('Delete From PDIFSLDO Where DIFS_Seq= '+
  xmodulo.Query1.FieldByName('VDIF_Seq').AsString );
 try
  BQuery.ExecSql ;
...
begin
 ...
 case xmodulo.modo of
  ...
  4 : if Application.MessageBox('Borrar Diferencia de Sueldo','Confirmar',
