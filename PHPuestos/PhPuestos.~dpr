...
begin
 ...
 BQuery.Sql.Add ('Delete From PhPuestos Where PUES_PSTO= '''+
  xmodulo.Query1.FieldByName('PUES_PSTO').AsString+ '''' );
 try
  BQuery.ExecSql ;
...
begin
 ...
 case xmodulo.modo of
  ...
  4 : if Application.MessageBox('Borrar Puesto HAS','Confirmar',
